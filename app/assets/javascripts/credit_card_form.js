...
// // function to handel the submit of the form and intercept the default event
...
//         }else {
//             show_error("Failed to load credit card processing functionlity please reload the page")
//         }
//         return false;
//     };
...
// // call plan change handler so that the plan is set correctly in the drop when the page loads
//     handlePlanChange(GetURLParameter('plan'), ".cc_form")

// // function to handle the token recived from Stripe and remove credit card fields
...
// // function to show errors when Stripe functionlity retune an error
